...
const CallToAction = () => {
  ...
  // NOTE: Assuming the number is from Mexico (+52). If not, the country code needs adjustment.
  const whatsappNumber = "526182303777";
    ...
    <div className={styles.wrapper}>
      <div className={styles.card}>
        ...
        <button className={styles.closeButton} onClick={() => setIsVisible(false)}>
          <span className="material-icons" style={{ fontSize: '20px' }}>x</span>
        </button>
        ...
        <div className={styles.content}>
          ...
          {/* CTA Button */}
          <a className={styles.ctaButton} href={whatsappLink} target="_blank" rel="noopener noreferrer">
